	...
	return (
		...
		>
				...
				<div className='flex items-center justify-between'>
					<div>
						...
						<p className='text-xs text-blue-600 mt-1'>
							Yodingizda tutib qolishni saqlab qo'ying
						</p>
					</div>{" "}
					<motion.div
			...
			<motion.div variants={itemVariants} className='w-full mb-6'>
				...
				<div className='bg-white rounded-2xl p-5 border border-slate-200 space-y-4'>
					...
					<div className='flex items-start gap-3 pb-4 border-b border-slate-200'>
						...
						<div>
							<p className='text-xs text-slate-600 mb-1'>Yo'naltirish</p>
							<p className='font-bold text-slate-900'>{route.destination}</p>
							<p className='text-xs text-slate-600 mt-1'>{route.origin} dan</p>
						</div>
					</div>
					...
					<div className='flex items-start gap-3 pb-4 border-b border-slate-200'>
						...
						<div>
							<p className='text-xs text-slate-600 mb-1'>Jo'nayish</p>
							<p className='font-bold text-slate-900'>{route.departureTime}</p>
							<p className='text-xs text-slate-600 mt-1'>
								{route.duration} safar
							</p>
						</div>
					</div>
					...
					<div className='flex items-start gap-3'>
						...
						<div>
							<p className='text-xs text-slate-600 mb-1'>O'rinlar</p>
			...
			<motion.div variants={itemVariants} className='w-full mb-8'>
				<h2 className='text-lg font-bold text-slate-900 mb-3'>To'lov</h2>
				<div className='bg-white rounded-2xl p-5 border border-slate-200 space-y-3'>
					<div className='flex justify-between'>
						...
						<span className='font-semibold text-slate-900'>
							{route.price.toLocaleString("uz-UZ")} so'm
						</span>
					</div>
					<div className='flex justify-between'>
						<span className='text-slate-600'>O'rinlar soni</span>
						<span className='font-semibold text-slate-900'>
							×{booking.seats.length}
						</span>
					</div>
					<div className='border-t border-slate-200 pt-3 flex justify-between items-center'>
						<span className='font-bold text-slate-900'>Jami Miqdori</span>
						<span className='text-3xl font-bold text-blue-600'>
							{booking.totalPrice.toLocaleString("uz-UZ")} so'm
						</span>
					</div>
			...
			<motion.div variants={itemVariants} className='w-full mb-8'>
				<div className='bg-amber-50 rounded-2xl p-4 border border-amber-200'>
					<p className='text-sm font-bold text-amber-900 mb-2'>Maslahatlar</p>
					<ul className='space-y-2 text-xs text-amber-800'>
						<li>
							• Jo'nayish vaqtidan 15 daqiqa oldin kelishni harakat qiling
						</li>
						<li>
							• Ruxsat etuvchi shaxsiy tasdiqlovchi hujjat bilan kelib olish
						</li>
						<li>• Oson kirish uchun chipta yuklab oling</li>
					</ul>
				</div>
			</motion.div>
